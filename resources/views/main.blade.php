                        ...
                        {{-- <section class="col-lg-7 connectedSortable">
                                        ...
                                        {{-- <div class="direct-chat-msg">
                                            ...
                                            {{-- <div class="direct-chat-infos clearfix">
                                                ...
                                                {{-- <span
                                                    ...
                                                    Pierce</span>--}}
                                                {{-- <span
                                                    class="direct-chat-timestamp float-right">23 Jan 2:00
                                                    pm</span>--}}
                                                {{-- </div>
                                            --}}
                                            {{--
                                            ...
                                            {{-- <li>--}}
                                                {{-- <a
                                                    ...
                                                    {{-- <div class="contacts-list-info">
                                                        ...
                                                        {{-- <span
                                                            class="contacts-list-msg">How have you been? I
                                                            was...</span>--}}
                                                        {{-- </div>
                                                    --}}
                                                    {{--
                                            ...
                                            {{-- <li>--}}
                                                {{-- <a
                                                    ...
                                                    {{-- <div class="contacts-list-info">
                                                        ...
                                                        {{-- <span
                                                            class="contacts-list-msg">I will be waiting
                                                            for...</span>--}}
                                                        {{-- </div>
                                                    --}}
                                                    {{--
                                            ...
                                            {{-- <li>--}}
                                                {{-- <a
                                                    ...
                                                    {{-- <div class="contacts-list-info">
                                                        ...
                                                        {{-- <span
                                                            class="contacts-list-msg">I'll call you back
                                                            at...</span>--}}
                                                        {{-- </div>
                                                    --}}
                                                    {{--
                                            ...
                                            {{-- <li>--}}
                                                {{-- <a
                                                    ...
                                                    {{-- <div class="contacts-list-info">
                                                        ...
                                                        {{-- <span
                                                            class="contacts-list-msg">Where is your
                                                            new...</span>--}}
                                                        {{-- </div>
                                                    --}}
                                                    {{--
                                            ...
                                            {{-- <li>--}}
                                                {{-- <a
                                                    ...
                                                    {{-- <div class="contacts-list-info">
                                                        ...
                                                        {{-- <span
                                                            class="contacts-list-msg">Can I take a look
                                                            at...</span>--}}
                                                        {{-- </div>
                                                    --}}
                                                    {{--
                                            ...
                                            {{-- <li>--}}
                                                {{-- <a
                                                    ...
                                                    {{-- <div class="contacts-list-info">
                                                        ...
                                                        {{-- <span
                                                            class="contacts-list-msg">Never mind I
                                                            found...</span>--}}
                                                        {{-- </div>
                                                    --}}
                                                    {{--
                            ...
                            {{-- <div class="card">--}}
                                ...
                                {{-- <div class="card-footer clearfix">
                                    --}}
                                    {{-- <button type="button"
                                        class="btn btn-info float-right"><i class="fas fa-plus"></i> Add
                                        item</button>--}}
                                    {{-- </div>--}}
                                {{--
                            </div>--}}
